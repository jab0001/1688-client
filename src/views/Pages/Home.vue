          ...
          <div class="row align-items-center">
            <div class="col-lg-6">
              <div class="pr-5">
                ...
                <div class="mt-5">
                  <a href="/dashboard" class="btn btn-neutral my-2"
                    >Explore Dashboard</a
                  >
                  <a
        ...
        <div class="row justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="btn-wrapper">
              <a
                href="https://demos.creative-tim.com/vue-argon-dashboard-pro/documentation/foundation/icons.html"
      ...
      <div class="container">
        <div class="row row-grid justify-content-center">
          <div class="col-lg-8 text-center">
            ...
            <div class="btn-wrapper">
              <a
                href="https://www.creative-tim.com/product/vue-argon-dashboard?ref=vadp-index-page"
              ...
              <a
                href="https://www.creative-tim.com/product/vue-argon-dashboard-pro?ref=vadp-index-page"
            ...
            <div class="text-center">
              ...
              <div class="row justify-content-center">
                <div class="col-md-2 col-3 my-2">
                  ...
                  >
                    <a
                      href="https://www.creative-tim.com/product/argon-dashboard?ref=vadp-index-page"
                      target="_blank"
                    >
                      <img
                ...
                <div class="col-md-2 col-3 my-2">
                  ...
                  >
                    <a
                      href="https://www.creative-tim.com/product/argon-dashboard-angular?ref=vadp-index-page"
                      target="_blank"
                    >
                      <img
                ...
                <div class="col-md-2 col-3 my-2">
                  ...
                  >
                    <a
                      href="https://www.creative-tim.com/product/argon-dashboard-react?ref=vadp-index-page"
                      target="_blank"
                    >
                      <img
